...
| `notebooks/03_baseline.ipynb` | ⏳ | 8 algoritma baseline karşılaştırması |
| `notebooks/04_tuning.ipynb` | ⏳ | Hyperparameter tuning (her üye kendi algoritması) |
| `notebooks/05_comparison.ipynb` | ⏳ | Final sonuç karşılaştırması + rapor |
| `PROJE_TEK_DOSYA.ipynb` | 📦 | Eski tek-dosya versiyonu (referans için) |
...
> **Not:** Aşağıdaki tablo `PROJE_TEK_DOSYA.ipynb` (eski versiyon) için. Yeni pipeline (`03_baseline.ipynb`) henüz çalıştırılmadı.
...
├── PROJE_TEK_DOSYA.ipynb          # Eski tek-dosya baseline (referans)
├── requirements.txt
└── README.md
```
